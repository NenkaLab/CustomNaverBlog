# See
This library was rebuilt directly into Coil3 because the original was not updated.
If you are looking for the original, go to [awxkee/avif-coder-coil](https://github.com/awxkee/avif-coder-coil)
...
```groovy
implementation 'com.github.awxkee:avif-coder-coil:-' // or any version above picker from release tags
```
